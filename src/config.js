...
export const URL_TABLES_BLUEPRINT =
  'https://predplatne.dennikn.sk/api/v1/segments/criteria';
export const URL_GET_PAYLOAD =
  'https://predplatne.dennikn.sk/api/v1/segments/show';
export const URL_POST_PAYLOAD =
